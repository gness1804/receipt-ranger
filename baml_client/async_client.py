...
class BamlAsyncClient:
    ...
    async def ExtractReceiptFromImage(self, image: baml_py.Image,exclusionCriteria: str,currentDate: str,
        baml_options: BamlCallOptions = {},
    ) -> types.Receipt:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            __stream__ = self.stream.ExtractReceiptFromImage(image=image,exclusionCriteria=exclusionCriteria,currentDate=currentDate,
                baml_options=baml_options)
            return await __stream__.get_final_response()
        else:
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="ExtractReceiptFromImage", args={
...
class BamlStreamClient:
    ...
    def ExtractReceiptFromImage(self, image: baml_py.Image,exclusionCriteria: str,currentDate: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.Receipt, types.Receipt]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="ExtractReceiptFromImage", args={
            "image": image,"exclusionCriteria": exclusionCriteria,"currentDate": currentDate,
        })
